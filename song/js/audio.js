...
function initMusic() {
    ...
    audio.src = "./../music/" + musicData[musicId];;
    audio.load();
    recordImg.classList.remove('rotate-play');
    audio.ondurationchange = function () {
        musicTitle.innerText = musicData[musicId];
        // author.innerText = musicData[musicId][1];
        author.innerText = '木子才';
        recordImg.style.backgroundImage = "url('img/record"+Math.floor(Math.random() * 4).toString()+".jpg')";
        body.style.backgroundImage = "url('img/bg"+Math.floor(Math.random() * 4).toString()+".png')";
